...
<html lang="en-US">
    ...
    <head>
        ...
        <!--  CSS Files
        ======================================================================== -->
        <link rel="stylesheet" href="js2/vendor/bootstrap/css/bootstrap.min.css">
        ...
        <!--  Head JS Libs
        ======================================================================== -->
        <script src="js2/vendor/modernizr-custom.js"></script>
    ...
    <body>
                                                        ...
                                                        <div class="header-cart-container">
                                                            ...
                                                            <ul class="shop-products">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <!-- Remove Button -->
                                                                    <a href="#" class="remove-btn" title="Remove this item">&times;</a>
                                                        ...
                                                        <ul class="submenu">
                                                            ...
                                                            <li>
                                                                ...
                                                                <ul class="submenu">
                                                                    ...
                                                                    <li class="current_page_item"><a href="elements-contact-block.html">Contact Block</a></li>
                ...
                <div class="section-container">
                    ...
                    <div class="breadcrumb-title">
                        ...
                        <div class="container">
                            ...
                            <h1 class="breadcrumb-main-title">Elements</h1>
                    ...
                    <div class="breadcrumb-block">
                        ...
                        <div class="container">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Contact Block</li>
                            </ol>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="section-title section-title-sm">
                                                <h2 class="section-main-title">Default</h2>
                                            </div><!-- /End Section Title -->


                                            <!-- Contact Block -->
                                            <div class="gfort-block contact-block" style="background-image: url(images/misc/world-map.png);">
                                                ...
                                                <div class="gfort-block-container">
                                                    ...
                                                    <div class="gfort-block-body">
                                                        ...
                                                        <div class="gfort-block-content">
                                                            ...
                                                            <strong>Email:</strong>
                                                            <p><a href="mailto:support@example.com" title="Support">support@example.com</a></p>

                                                            <strong>Phone:</strong>
                                                            <p><a href="tel:+11234567890" title="+1 123 456-7890">+1 123 456-7890</a></p>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <!-- Section Title -->
                                            <div class="section-title section-title-sm">
                                                <h2 class="section-main-title">Style 1</h2>
                                            </div><!-- /End Section Title -->


                                            <!-- Contact Block -->
                                            <div class="gfort-block contact-block gfort-block-style-1" style="background-image: url(images/misc/world-map-1.png);">
                                                <!-- gfort Block Container -->
                                                <div class="gfort-block-container">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <!-- Section Title -->
                                            <div class="section-title section-title-sm">
                                                <h2 class="section-main-title">Style 2</h2>
                                            </div><!-- /End Section Title -->


                                            <!-- Contact Block -->
                                            <div class="gfort-block contact-block gfort-block-style-2" style="background-image: url(images/misc/world-map-2.png);">
                                                <!-- gfort Block Container -->
                                                <div class="gfort-block-container">
        ...
        <!-- Java Script Files
        ======================================================================== -->
        <script type="text/javascript" src="js2/vendor/jquery.min.js"></script>
