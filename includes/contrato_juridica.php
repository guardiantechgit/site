Pelo presente instrumento particular, de um lado a empresa GUARDIANTECH SEGURANÇA E TECNOLOGIA LTDA, pessoa jurídica de direito privado, inscrita no CNPJ sob o nº 41.265.347/0001-43, com Inscrição Estadual nº 668.133.154.117, doravante denominada GUARDIANTECH, e, de outro lado, a pessoa jurídica qualificada no termo de instalação e aceite (razão social, CNPJ, endereço, e identificação do representante legal), doravante denominada CONTRATANTE, têm entre si justo e contratado o que segue:

CLÁUSULA PRIMEIRA – DO OBJETO
1.1 – O presente contrato tem por objeto a prestação de serviços de rastreamento e monitoramento veicular, via plataforma GuardianTrack Rastreamento, incluindo acesso por aplicativo e/ou web, bem como o fornecimento do equipamento rastreador, em regime de comodato, para instalação nos seguintes tipos de veículos de propriedade do CONTRATANTE e/ou sob sua posse direta e legítima:
...
a) Solicitação expressa do CONTRATANTE, por meio de seu representante legal e/ou preposto formalmente autorizado;
b) Situações de furto, roubo ou emergência;
c) Exigência legal ou judicial;
d) Solução de falhas no equipamento.

1.4 – Em todos os demais casos, o acesso à localização e funcionalidades será exclusivamente do CONTRATANTE, por meio de login e senha vinculados à sua conta corporativa. O CONTRATANTE poderá cadastrar usuários internos (representantes, prepostos, colaboradores) para acesso à plataforma, responsabilizando-se integralmente por todos os acessos, comandos e ações realizados, inclusive quando compartilhados com terceiros.
...
2.3 – Em caso de cancelamento do contrato, será agendada a retirada do equipamento em até 7 (sete) dias contados a partir da solicitação formal do CONTRATANTE, realizada por seu representante legal e/ou preposto autorizado.
...
3.3 – O acesso ao aplicativo/plataforma será bloqueado automaticamente após 10 (dez) dias de inadimplência, sendo restabelecido após a regularização do pagamento.
...
6.1 – O contrato é firmado por prazo indeterminado, podendo ser rescindido a qualquer momento pelo CONTRATANTE, por solicitação formal realizada por seu representante legal e/ou preposto autorizado.
...
Ao enviar a ficha de cadastro, o CONTRATANTE declara aceitar todos os termos e cláusulas deste contrato, reconhecendo sua validade jurídica e conformidade com a legislação vigente.